...
export const sw: EnglishMessages = {
  ...
  landing: {
    ...
    features: {
      ...
      body: 'Hazina — treasure kwa Kiswahili — inawakilisha thamani iliyofichika ndani ya maarifa yako ya on-chain. Acha kuyatoa bure. Yafanye yaingize mapato kwa usalama.',
      items: {
        micropayments: {
    ...
    cta: {
      ...
      body: 'Jiunge na wauzaji ambao tayari wanapata USDC kwa njia ya pasivu. Data yako ni hazina yako — ni wakati wa kuifungua.',
    },
    footer: {
      tagline:
        'Imejengwa kwenye Stellar Testnet · Inaendeshwa na Anthropic Claude · Itifaki ya x402',
    },
  },
  marketplace: {
    eyebrow: 'Tafuta na nunua',
    title: 'Soko la data',
    subtitle: 'Maarifa bora ya on-chain, yenye bei kwa kila swali. Lipa tu kwa unachohitaji.',
    searchPlaceholder: 'Tafuta dataset...',
    filterBy: 'Chuja kwa {type}',
    filters: {
      minPrice: 'Bei ya chini',
      maxPrice: 'Bei ya juu',
      minQueries: 'Maswali ya chini',
      reset: 'Weka upya',
      selectedTypes: '{count} zimechaguliwa',
    },
    pagination: {
  ...
  queryModal: {
    ...
    details: {
      ...
      escrowNote: 'Escrow ya AI huthibitisha malipo yako kwenye Stellar kabla ya kuachilia data',
    },
    payment: {
      ...
      demoModeDescription: 'ruka malipo, pata tu uchambuzi wa AI (hali ya hackathon)',
    },
    verifying: {
  ...
  bundles: {
    eyebrow: 'Vifurushi vya Data',
    title: 'Vifurushi vya Data',
    subtitle:
      'Wauzaji kadhaa, ununuzi mmoja, bei moja — kila muuzaji analipwa kwa pamoja mnunuzi anapolipa.',
    card: {
      badge: 'Kifurushi',
      componentsCount: 'dataset {count}',
      curatorLabel: 'Imeratibiwa na {wallet}',
      curatorFee: 'Ada ya mratibu {pct}%',
      buyLabel: 'Nunua Kifurushi — ${price} USDC',
      degradedBadge: 'Haipatikani',
      viewSplits: 'Angalia mgawanyo',
    },
    detail: {
      title: 'Unachopata',
      splitsTitle: 'Mgawanyo wa mapato',
      datasetShare: '{name}',
      curatorShare: 'Ada ya mratibu',
      shareOfPurchase: '{pct}% ya ununuzi',
    },
    purchase: {
      connecting: 'Inaunganisha pochi...',
      locking: 'Inafunga fedha kwenye mnyororo (lock_multi)...',
      delivering: 'Inatoa vipengele...',
      confirming: 'Thibitisha kupokea ({current}/{total})',
      releasing: 'Inatoa malipo kwa kila muuzaji...',
      success: 'Ununuzi umekamilika — kila muuzaji amelipwa kwa pamoja',
      refunded: 'Kipengele kimoja hakikuweza kutolewa — umerudishiwa fedha zote',
      failed: 'Ununuzi umeshindwa — unahitaji ukaguzi wa mikono',
      error: 'Ununuzi umeshindwa: {message}',
      confirmCta: 'Thibitisha Kupokea',
      viewSummary: 'Muhtasari wa dataset zote',
      close: 'Funga',
    },
    curator: {
      eyebrow: 'Ratibu',
      title: 'Unda Kifurushi cha Data',
      subtitle:
        'Changanya dataset kutoka kwa wauzaji kadhaa kuwa bidhaa moja kwa bei moja. Kila muuzaji — na wewe — mnalipwa kwa pamoja mara tu mnunuzi anapolipa.',
      nameLabel: 'Jina la Kifurushi',
      namePlaceholder: 'mf. DeFi Risk Pack',
      descriptionLabel: 'Maelezo',
      descriptionPlaceholder: 'Eleza mnunuzi anapata nini na kwa nini dataset hizi zinaendana...',
      curatorWalletLabel: 'Anwani yako ya Pochi ya Stellar',
      curatorWalletPlaceholder: 'G... (funguo za umma za Stellar herufi 56)',
      curatorWalletError:
        'Weka funguo sahihi za umma za Stellar (huanza na G, hutumia A-Z au 2-7, na ni herufi 56 hasa)',
      priceLabel: 'Bei ya Kifurushi (USDC)',
      priceError: 'Bei lazima iwe kubwa kuliko 0',
      curatorFeeLabel: 'Ada Yako',
      componentsTitle: 'Dataset za Kifurushi',
      componentsEmpty: 'Chagua dataset hapa chini kuziongeza kwenye kifurushi hiki.',
      addComponent: 'Ongeza kwenye kifurushi',
      removeComponent: 'Ondoa',
      alreadyAdded: 'Tayari imeongezwa',
      shareLabel: 'Mgawo',
      splitTotal: 'Jumla ya mgawanyo',
      splitTotalOk: 'Mgawanyo umefikia 100% kamili',
      splitTotalError: 'Mgawanyo lazima ufikie 100% kamili (kwa sasa {total}%)',
      preview: {
        title: 'Muhtasari wa mnunuzi',
        priceLine: 'Mnunuzi analipa ${price} USDC mara moja',
        sellerGets: '{name}: ${amount} USDC ({pct}%)',
        curatorGets: 'Wewe: ${amount} USDC ({pct}%)',
      },
      submit: 'Chapisha Kifurushi',
      submitting: 'Inachapisha...',
      success: 'Kifurushi kimechapishwa!',
      successBody: '{name} sasa kiko sokoni.',
      error: 'Imeshindwa kuunda kifurushi',
      noDatasetsSelected: 'Chagua angalau dataset moja kuongeza kwenye kifurushi chako',
      pickerTitle: 'Dataset Zinazopatikana',
      pickerSearchPlaceholder: 'Tafuta dataset zako za kuongeza...',
      pickerEmpty: 'Hakuna dataset za kuongeza',
    },
    dashboard: {
      curatorTitle: 'Vifurushi Vyako',
      curatorEmpty: 'Bado hujaratibu kifurushi chochote',
      curatorCreateCta: 'Unda Kifurushi',
      sellerTitle: 'Vifurushi Vinavyojumuisha Data Yako',
      sellerEmpty: 'Hakuna dataset yako iliyo kwenye kifurushi bado',
      totalEarned: 'Jumla ya mapato',
      purchases: 'ununuzi {count}',
      released: '{count} zimetolewa',
    },
  },
};
