...
export const fr: EnglishMessages = {
  ...
  bundles: {
    eyebrow: 'Offres groupées',
    title: 'Offres groupées de données',
    subtitle:
      'Plusieurs vendeurs, un seul achat, un seul prix — chaque vendeur est payé de manière atomique au paiement.',
    card: {
      badge: 'Offre groupée',
      componentsCount: '{count} datasets',
      curatorLabel: 'Organisée par {wallet}',
      curatorFee: 'Commission du curateur {pct}%',
      buyLabel: "Acheter l'offre groupée — ${price} USDC",
      degradedBadge: 'Indisponible',
      viewSplits: 'Voir la répartition',
    },
    detail: {
      title: 'Ce que vous obtenez',
      splitsTitle: 'Répartition des revenus',
      datasetShare: '{name}',
      curatorShare: 'Commission du curateur',
      shareOfPurchase: '{pct}% de l’achat',
    },
    purchase: {
      connecting: 'Connexion du portefeuille...',
      locking: 'Verrouillage des fonds on-chain (lock_multi)...',
      delivering: 'Livraison des composants...',
      confirming: 'Confirmez la réception ({current}/{total})',
      releasing: 'Versement du paiement à chaque vendeur...',
      success: 'Achat terminé — chaque vendeur a été payé de manière atomique',
      refunded: "Un composant n'a pas pu être livré — vous avez été intégralement remboursé",
      failed: 'Échec de l’achat — nécessite une vérification manuelle',
      error: "Échec de l'achat : {message}",
      confirmCta: 'Confirmer la réception',
      viewSummary: 'Synthèse inter-datasets',
      close: 'Fermer',
    },
    curator: {
      eyebrow: 'Curation',
      title: 'Créer une offre groupée de données',
      subtitle:
        "Combinez des datasets de plusieurs vendeurs en un seul produit à un seul prix. Chaque vendeur — et vous — est payé de manière atomique dès qu'un acheteur passe commande.",
      nameLabel: "Nom de l'offre groupée",
      namePlaceholder: 'ex. DeFi Risk Pack',
      descriptionLabel: 'Description',
      descriptionPlaceholder:
        'Décrivez ce que reçoivent les acheteurs et pourquoi ces datasets vont ensemble...',
      curatorWalletLabel: 'Votre adresse de portefeuille Stellar',
      curatorWalletPlaceholder: 'G... (clé publique Stellar de 56 caractères)',
      curatorWalletError:
        'Saisissez une clé publique Stellar valide (commence par G, utilise A-Z ou 2-7, et compte exactement 56 caractères)',
      priceLabel: "Prix de l'offre groupée (USDC)",
      priceError: 'Le prix doit être supérieur à 0',
      curatorFeeLabel: 'Votre commission',
      componentsTitle: 'Datasets composant l’offre',
      componentsEmpty: 'Sélectionnez des datasets ci-dessous pour les ajouter à cette offre.',
      addComponent: 'Ajouter à l’offre',
      removeComponent: 'Retirer',
      alreadyAdded: 'Déjà ajouté',
      shareLabel: 'Part',
      splitTotal: 'Total de la répartition',
      splitTotalOk: 'La répartition totalise exactement 100%',
      splitTotalError: 'La répartition doit totaliser exactement 100% (actuellement {total}%)',
      preview: {
        title: 'Aperçu acheteur',
        priceLine: "L'acheteur paie ${price} USDC en une seule fois",
        sellerGets: '{name} : ${amount} USDC ({pct}%)',
        curatorGets: 'Vous : ${amount} USDC ({pct}%)',
      },
      submit: "Publier l'offre groupée",
      submitting: 'Publication...',
      success: 'Offre groupée publiée !',
      successBody: '{name} est maintenant disponible sur la marketplace.',
      error: "Échec de la création de l'offre groupée",
      noDatasetsSelected: 'Sélectionnez au moins un dataset à ajouter à votre offre groupée',
      pickerTitle: 'Datasets disponibles',
      pickerSearchPlaceholder: 'Recherchez vos datasets à ajouter...',
      pickerEmpty: 'Aucun dataset disponible à ajouter',
    },
    dashboard: {
      curatorTitle: 'Vos offres groupées',
      curatorEmpty: "Vous n'avez encore organisé aucune offre groupée",
      curatorCreateCta: 'Créer une offre groupée',
      sellerTitle: 'Offres groupées incluant vos données',
      sellerEmpty: "Aucun de vos datasets n'est encore dans une offre groupée",
      totalEarned: 'Total gagné',
      purchases: '{count} achats',
      released: '{count} versées',
    },
  },
};
