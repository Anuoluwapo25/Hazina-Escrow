...
export const es: EnglishMessages = {
  ...
  sell: {
    ...
    form: {
      ...
      notificationEmail: 'Correo de notificación de consultas',
      notificationEmailPlaceholder: 'vendedor@ejemplo.com',
      notificationEmailError: 'Introduce una dirección de correo válida',
      notificationEmailHelp: 'Recibe un correo cuando este dataset se consulte correctamente',
  ...
  bundles: {
    eyebrow: 'Paquetes compuestos',
    title: 'Paquetes de datos',
    subtitle:
      'Varios vendedores, una sola compra, un solo precio — cada vendedor cobra de forma atómica al pagar.',
    card: {
      badge: 'Paquete',
      componentsCount: '{count} datasets',
      curatorLabel: 'Curado por {wallet}',
      curatorFee: 'Comisión del curador {pct}%',
      buyLabel: 'Comprar paquete — ${price} USDC',
      degradedBadge: 'No disponible',
      viewSplits: 'Ver reparto',
    },
    detail: {
      title: 'Qué incluye',
      splitsTitle: 'Reparto de ingresos',
      datasetShare: '{name}',
      curatorShare: 'Comisión del curador',
      shareOfPurchase: '{pct}% de la compra',
    },
    purchase: {
      connecting: 'Conectando billetera...',
      locking: 'Bloqueando fondos en cadena (lock_multi)...',
      delivering: 'Entregando componentes...',
      confirming: 'Confirma recepción ({current}/{total})',
      releasing: 'Liberando el pago a cada vendedor...',
      success: 'Compra completada — todos los vendedores cobraron de forma atómica',
      refunded: 'Un componente no pudo entregarse — se te reembolsó por completo',
      failed: 'La compra falló — requiere revisión manual',
      error: 'La compra falló: {message}',
      confirmCta: 'Confirmar recepción',
      viewSummary: 'Resumen entre datasets',
      close: 'Cerrar',
    },
    curator: {
      eyebrow: 'Curar',
      title: 'Crear un paquete de datos',
      subtitle:
        'Combina datasets de varios vendedores en un solo producto a un solo precio. Cada vendedor — y tú — cobra de forma atómica en cuanto un comprador paga.',
      nameLabel: 'Nombre del paquete',
      namePlaceholder: 'p. ej. DeFi Risk Pack',
      descriptionLabel: 'Descripción',
      descriptionPlaceholder:
        'Describe qué recibe el comprador y por qué estos datasets van juntos...',
      curatorWalletLabel: 'Tu dirección de billetera Stellar',
      curatorWalletPlaceholder: 'G... (clave pública Stellar de 56 caracteres)',
      curatorWalletError:
        'Ingresa una clave pública Stellar válida (empieza con G, usa A-Z o 2-7, y tiene exactamente 56 caracteres)',
      priceLabel: 'Precio del paquete (USDC)',
      priceError: 'El precio debe ser mayor que 0',
      curatorFeeLabel: 'Tu comisión',
      componentsTitle: 'Datasets del paquete',
      componentsEmpty: 'Selecciona datasets abajo para añadirlos a este paquete.',
      addComponent: 'Añadir al paquete',
      removeComponent: 'Quitar',
      alreadyAdded: 'Ya añadido',
      shareLabel: 'Reparto',
      splitTotal: 'Total del reparto',
      splitTotalOk: 'El reparto suma exactamente 100%',
      splitTotalError: 'El reparto debe sumar exactamente 100% (actualmente {total}%)',
      preview: {
        title: 'Vista previa del comprador',
        priceLine: 'El comprador paga ${price} USDC una sola vez',
        sellerGets: '{name}: ${amount} USDC ({pct}%)',
        curatorGets: 'Tú: ${amount} USDC ({pct}%)',
      },
      submit: 'Publicar paquete',
      submitting: 'Publicando...',
      success: '¡Paquete publicado!',
      successBody: '{name} ya está disponible en el marketplace.',
      error: 'No se pudo crear el paquete',
      noDatasetsSelected: 'Selecciona al menos un dataset para añadir a tu paquete',
      pickerTitle: 'Datasets disponibles',
      pickerSearchPlaceholder: 'Busca tus datasets para añadir...',
      pickerEmpty: 'No hay datasets disponibles para añadir',
    },
    dashboard: {
      curatorTitle: 'Tus paquetes',
      curatorEmpty: 'Aún no has curado ningún paquete',
      curatorCreateCta: 'Crear un paquete',
      sellerTitle: 'Paquetes que incluyen tus datos',
      sellerEmpty: 'Ninguno de tus datasets está en un paquete todavía',
      totalEarned: 'Total ganado',
      purchases: '{count} compras',
      released: '{count} liberadas',
    },
  },
};
